...
function AdminDepositPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/admin/process-deposit', {
        method: 'POST',
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-muted-foreground mb-2">
                    ${Number.parseFloat(amount).toLocaleString()} deposited to {customer?.name}'s account
                  </p>
                  {transactionRef && (
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Record customer deposit transaction</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
